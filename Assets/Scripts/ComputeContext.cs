...
public struct Compute_Shaders
{
    ...
    {
        bind_buffers_on_compute(compute_selection_functions, new int[] { trans_fitness_to_prob_handel, parent_selection_handel, cross_over_handel, mutation_and_copy_handel }, "_population_pool", buffer);
    }

    public void bind_second_gen_buffer(ComputeBuffer buffer)
    {
        bind_buffers_on_compute(compute_selection_functions, new int[] { cross_over_handel, mutation_and_copy_handel }, "_second_gen_population_pool", buffer);
    }
